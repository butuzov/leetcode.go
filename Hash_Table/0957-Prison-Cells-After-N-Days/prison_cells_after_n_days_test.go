...
func test(t *testing.T, fnc func([]int, int) []int) {
	...
	for i, test := range TestCases {
		t.Run(fmt.Sprintf("%s(%d)", name, i), func(t *testing.T) {
			assert.Equal(t, test.expected, fnc(test.cells, test.N))
		})
	}
}
...
func TestPrisonAfterNDays(t *testing.T) {
	test(t, prisonAfterNDays)
}

func TestPrisonAfterNDaysNaive(t *testing.T) {
	test(t, prisonAfterNDaysNaive)
}

func TestPrisonAfterNDaysUnknownAuthor(t *testing.T) {
	test(t, prisonAfterNDaysUnknownAuthor)
}

func BenchmarkPrisonAfterNDays(b *testing.B) {
	bench(b, prisonAfterNDays)
}

func BenchmarkPrisonAfterNDaysNaive(b *testing.B) {
	bench(b, prisonAfterNDaysNaive)
}

func BenchmarkPrisonAfterNDaysUnknownAuthor(b *testing.B) {
	bench(b, prisonAfterNDaysUnknownAuthor)
}
