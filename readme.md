...
1025 | [Divisor Game](https://leetcode.com/problems/divisor-game) | Easy  | `Math`, `Dynamic Programming`
...
1009 | [Complement of Base 10 Integer](https://leetcode.com/problems/complement-of-base-10-integer) | Easy  | `Math`
...
1000 | [Minimum Cost to Merge Stones](https://leetcode.com/problems/minimum-cost-to-merge-stones) | Hard  | `Dynamic Programming`
 ...
 951 | [Flip Equivalent Binary Trees](https://leetcode.com/problems/flip-equivalent-binary-trees) | Normal  | `Tree`
 ...
 801 | [Minimum Swaps To Make Sequences Increasing](https://leetcode.com/problems/minimum-swaps-to-make-sequences-increasing) | Normal  | `Dynamic Programming`
 ...
 754 | [Reach a Number](https://leetcode.com/problems/reach-a-number) | Easy  | `Math`
 ...
 664 | [Strange Printer](https://leetcode.com/problems/strange-printer) | Hard  | `Dynamic Programming`, `Depth-first Search`
 ...
 599 | [Minimum Index Sum of Two Lists](https://leetcode.com/problems/minimum-index-sum-of-two-lists) | Easy  | `Hash Table`
 ...
 537 | [Complex Number Multiplication](https://leetcode.com/problems/complex-number-multiplication) | Normal  | `Math`, `String`
 ...
 523 | [Continuous Subarray Sum](https://leetcode.com/problems/continuous-subarray-sum) | Normal  | `Math`, `Dynamic Programming`
 ...
 486 | [Predict the Winner](https://leetcode.com/problems/predict-the-winner) | Normal  | `Dynamic Programming`, `Minimax`
 ...
 481 | [Magical String](https://leetcode.com/problems/magical-string) | Normal  | 
 480 | [Sliding Window Median](https://leetcode.com/problems/sliding-window-median) | Hard  | `Sliding Window`
 478 | [Generate Random Point in a Circle](https://leetcode.com/problems/generate-random-point-in-a-circle) | Normal  | `Math`, `Random`, `Rejection Sampling`
 476 | [Number Complement](https://leetcode.com/problems/number-complement) | Easy  | `Bit Manipulation`
 475 | [Heaters](https://leetcode.com/problems/heaters) | Easy  | `Binary Search`
 474 | [Ones and Zeroes](https://leetcode.com/problems/ones-and-zeroes) | Normal  | `Dynamic Programming`
 473 | [Matchsticks to Square](https://leetcode.com/problems/matchsticks-to-square) | Normal  | `Depth-first Search`
 472 | [Concatenated Words](https://leetcode.com/problems/concatenated-words) | Hard  | `Dynamic Programming`, `Depth-first Search`, `Trie`
 470 | [Implement Rand10() Using Rand7()](https://leetcode.com/problems/implement-rand10-using-rand7) | Normal  | `Random`, `Rejection Sampling`
 468 | [Validate IP Address](https://leetcode.com/problems/validate-ip-address) | Normal  | `String`
 467 | [Unique Substrings in Wraparound String](https://leetcode.com/problems/unique-substrings-in-wraparound-string) | Normal  | `Dynamic Programming`
 466 | [Count The Repetitions](https://leetcode.com/problems/count-the-repetitions) | Hard  | `Dynamic Programming`
 464 | [Can I Win](https://leetcode.com/problems/can-i-win) | Normal  | `Dynamic Programming`, `Minimax`
 463 | [Island Perimeter](https://leetcode.com/problems/island-perimeter) | Easy  | `Hash Table`
 462 | [Minimum Moves to Equal Array Elements II](https://leetcode.com/problems/minimum-moves-to-equal-array-elements-ii) | Normal  | `Math`
 ...
 458 | [Poor Pigs](https://leetcode.com/problems/poor-pigs) | Hard  | `Math`
 457 | [Circular Array Loop](https://leetcode.com/problems/circular-array-loop) | Normal  | `Array`, `Two Pointers`
 456 | [132 Pattern](https://leetcode.com/problems/132-pattern) | Normal  | `Stack`
 455 | [Assign Cookies](https://leetcode.com/problems/assign-cookies) | Easy  | `Greedy`
 454 | [4Sum II](https://leetcode.com/problems/4sum-ii) | Normal  | `Hash Table`, `Binary Search`
 453 | [Minimum Moves to Equal Array Elements](https://leetcode.com/problems/minimum-moves-to-equal-array-elements) | Easy  | `Math`
 452 | [Minimum Number of Arrows to Burst Balloons](https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons) | Normal  | `Greedy`
 451 | [Sort Characters By Frequency](https://leetcode.com/problems/sort-characters-by-frequency) | Normal  | `Hash Table`, `Heap`
 450 | [Delete Node in a BST](https://leetcode.com/problems/delete-node-in-a-bst) | Normal  | `Tree`
 ...
 447 | [Number of Boomerangs](https://leetcode.com/problems/number-of-boomerangs) | Easy  | `Hash Table`
 ...
 442 | [Find All Duplicates in an Array](https://leetcode.com/problems/find-all-duplicates-in-an-array) | Normal  | `Array`
 ...
 433 | [Minimum Genetic Mutation](https://leetcode.com/problems/minimum-genetic-mutation) | Normal  | 
 432 | [All O`one Data Structure](https://leetcode.com/problems/all-oone-data-structure) | Hard  | `Design`
 424 | [Longest Repeating Character Replacement](https://leetcode.com/problems/longest-repeating-character-replacement) | Normal  | `Two Pointers`, `Sliding Window`
 423 | [Reconstruct Original Digits from English](https://leetcode.com/problems/reconstruct-original-digits-from-english) | Normal  | `Math`
 421 | [Maximum XOR of Two Numbers in an Array](https://leetcode.com/problems/maximum-xor-of-two-numbers-in-an-array) | Normal  | `Bit Manipulation`, `Trie`
 420 | [Strong Password Checker](https://leetcode.com/problems/strong-password-checker) | Hard  | 
 419 | [Battleships in a Board](https://leetcode.com/problems/battleships-in-a-board) | Normal  | 
 417 | [Pacific Atlantic Water Flow](https://leetcode.com/problems/pacific-atlantic-water-flow) | Normal  | `Depth-first Search`, `Breadth-first Search`
 416 | [Partition Equal Subset Sum](https://leetcode.com/problems/partition-equal-subset-sum) | Normal  | `Dynamic Programming`
 ...
 406 | [Queue Reconstruction by Height](https://leetcode.com/problems/queue-reconstruction-by-height) | Normal  | `Greedy`
 ...
 396 | [Rotate Function](https://leetcode.com/problems/rotate-function) | Normal  | `Math`
 ...
 382 | [Linked List Random Node](https://leetcode.com/problems/linked-list-random-node) | Normal  | `Reservoir Sampling`
 ...
 380 | [Insert Delete GetRandom O(1)](https://leetcode.com/problems/insert-delete-getrandom-o1) | Normal  | `Array`, `Hash Table`, `Design`
 378 | [Kth Smallest Element in a Sorted Matrix](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix) | Normal  | `Binary Search`, `Heap`
 377 | [Combination Sum IV](https://leetcode.com/problems/combination-sum-iv) | Normal  | `Dynamic Programming`
 376 | [Wiggle Subsequence](https://leetcode.com/problems/wiggle-subsequence) | Normal  | `Dynamic Programming`, `Greedy`
 375 | [Guess Number Higher or Lower II](https://leetcode.com/problems/guess-number-higher-or-lower-ii) | Normal  | `Dynamic Programming`, `Minimax`
 373 | [Find K Pairs with Smallest Sums](https://leetcode.com/problems/find-k-pairs-with-smallest-sums) | Normal  | `Heap`
 372 | [Super Pow](https://leetcode.com/problems/super-pow) | Normal  | `Math`
 371 | [Sum of Two Integers](https://leetcode.com/problems/sum-of-two-integers) | Easy  | `Bit Manipulation`
 368 | [Largest Divisible Subset](https://leetcode.com/problems/largest-divisible-subset) | Normal  | `Math`, `Dynamic Programming`
 365 | [Water and Jug Problem](https://leetcode.com/problems/water-and-jug-problem) | Normal  | `Math`
 ...
 357 | [Count Numbers with Unique Digits](https://leetcode.com/problems/count-numbers-with-unique-digits) | Normal  | `Math`, `Dynamic Programming`, `Backtracking`
 355 | [Design Twitter](https://leetcode.com/problems/design-twitter) | Normal  | `Hash Table`, `Heap`, `Design`
 ...
 347 | [Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements) | Normal  | `Hash Table`, `Heap`
 343 | [Integer Break](https://leetcode.com/problems/integer-break) | Normal  | `Math`, `Dynamic Programming`
 337 | [House Robber III](https://leetcode.com/problems/house-robber-iii) | Normal  | `Tree`, `Depth-first Search`
 ...
 332 | [Reconstruct Itinerary](https://leetcode.com/problems/reconstruct-itinerary) | Normal  | `Depth-first Search`, `Graph`
 331 | [Verify Preorder Serialization of a Binary Tree](https://leetcode.com/problems/verify-preorder-serialization-of-a-binary-tree) | Normal  | `Stack`
 ...
 328 | [Odd Even Linked List](https://leetcode.com/problems/odd-even-linked-list) | Normal  | `Linked List`
 327 | [Count of Range Sum](https://leetcode.com/problems/count-of-range-sum) | Hard  | `Binary Search`, `Divide and Conquer`, `Sort`, `Binary Indexed Tree`, `Segment Tree`
 324 | [Wiggle Sort II](https://leetcode.com/problems/wiggle-sort-ii) | Normal  | `Sort`
 322 | [Coin Change](https://leetcode.com/problems/coin-change) | Normal  | `Dynamic Programming`
 321 | [Create Maximum Number](https://leetcode.com/problems/create-maximum-number) | Hard  | `Dynamic Programming`, `Greedy`
 319 | [Bulb Switcher](https://leetcode.com/problems/bulb-switcher) | Normal  | `Math`, `Brainteaser`
 318 | [Maximum Product of Word Lengths](https://leetcode.com/problems/maximum-product-of-word-lengths) | Normal  | `Bit Manipulation`
 ...
 310 | [Minimum Height Trees](https://leetcode.com/problems/minimum-height-trees) | Normal  | `Breadth-first Search`, `Graph`
 309 | [Best Time to Buy and Sell Stock with Cooldown](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-cooldown) | Normal  | `Dynamic Programming`
 307 | [Range Sum Query - Mutable](https://leetcode.com/problems/range-sum-query-mutable) | Normal  | `Binary Indexed Tree`, `Segment Tree`
 306 | [Additive Number](https://leetcode.com/problems/additive-number) | Normal  | `Backtracking`
 304 | [Range Sum Query 2D - Immutable](https://leetcode.com/problems/range-sum-query-2d-immutable) | Normal  | `Dynamic Programming`
 ...
 289 | [Game of Life](https://leetcode.com/problems/game-of-life) | Normal  | `Array`
 287 | [Find the Duplicate Number](https://leetcode.com/problems/find-the-duplicate-number) | Normal  | `Array`, `Two Pointers`, `Binary Search`
 ...
 260 | [Single Number III](https://leetcode.com/problems/single-number-iii) | Normal  | `Bit Manipulation`
 ...
 230 | [Kth Smallest Element in a BST](https://leetcode.com/problems/kth-smallest-element-in-a-bst) | Normal  | `Binary Search`, `Tree`
 229 | [Majority Element II](https://leetcode.com/problems/majority-element-ii) | Normal  | `Array`
 228 | [Summary Ranges](https://leetcode.com/problems/summary-ranges) | Normal  | `Array`
 227 | [Basic Calculator II](https://leetcode.com/problems/basic-calculator-ii) | Normal  | `String`
 ...
 223 | [Rectangle Area](https://leetcode.com/problems/rectangle-area) | Normal  | `Math`
 222 | [Count Complete Tree Nodes](https://leetcode.com/problems/count-complete-tree-nodes) | Normal  | `Binary Search`, `Tree`
 221 | [Maximal Square](https://leetcode.com/problems/maximal-square) | Normal  | `Dynamic Programming`
 ...
 210 | [Course Schedule II](https://leetcode.com/problems/course-schedule-ii) | Normal  | `Depth-first Search`, `Breadth-first Search`, `Graph`, `Topological Sort`
 209 | [Minimum Size Subarray Sum](https://leetcode.com/problems/minimum-size-subarray-sum) | Normal  | `Array`, `Two Pointers`, `Binary Search`
 208 | [Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree) | Normal  | `Design`, `Trie`
 207 | [Course Schedule](https://leetcode.com/problems/course-schedule) | Normal  | `Depth-first Search`, `Breadth-first Search`, `Graph`, `Topological Sort`
 ...
 131 | [Palindrome Partitioning](https://leetcode.com/problems/palindrome-partitioning) | Normal  | `Backtracking`
 130 | [Surrounded Regions](https://leetcode.com/problems/surrounded-regions) | Normal  | `Depth-first Search`, `Breadth-first Search`, `Union Find`
 129 | [Sum Root to Leaf Numbers](https://leetcode.com/problems/sum-root-to-leaf-numbers) | Normal  | `Tree`, `Depth-first Search`
 ...
 100 | [Same Tree](https://leetcode.com/problems/same-tree) | Easy  | `Tree`, `Depth-first Search`
  ...
  90 | [Subsets II](https://leetcode.com/problems/subsets-ii) | Normal  | `Array`, `Backtracking`
  89 | [Gray Code](https://leetcode.com/problems/gray-code) | Normal  | `Backtracking`
  ...
  86 | [Partition List](https://leetcode.com/problems/partition-list) | Normal  | `Linked List`, `Two Pointers`
  ...
  82 | [Remove Duplicates from Sorted List II](https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii) | Normal  | `Linked List`
  81 | [Search in Rotated Sorted Array II](https://leetcode.com/problems/search-in-rotated-sorted-array-ii) | Normal  | `Array`, `Binary Search`
  80 | [Remove Duplicates from Sorted Array II](https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii) | Normal  | `Array`, `Two Pointers`
  79 | [Word Search](https://leetcode.com/problems/word-search) | Normal  | `Array`, `Backtracking`
  ...
  40 | [Combination Sum II](https://leetcode.com/problems/combination-sum-ii) | Normal  | `Array`, `Backtracking`
  39 | [Combination Sum](https://leetcode.com/problems/combination-sum) | Normal  | `Array`, `Backtracking`
  ...
  31 | [Next Permutation](https://leetcode.com/problems/next-permutation) | Normal  | `Array`
  ...
  24 | [Swap Nodes in Pairs](https://leetcode.com/problems/swap-nodes-in-pairs) | Normal  | `Linked List`
  22 | [Generate Parentheses](https://leetcode.com/problems/generate-parentheses) | Normal  | `String`, `Backtracking`
  19 | [Remove Nth Node From End of List](https://leetcode.com/problems/remove-nth-node-from-end-of-list) | Normal  | `Linked List`, `Two Pointers`
  18 | [4Sum](https://leetcode.com/problems/4sum) | Normal  | `Array`, `Hash Table`, `Two Pointers`
  17 | [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number) | Normal  | `String`, `Backtracking`
  16 | [3Sum Closest](https://leetcode.com/problems/3sum-closest) | Normal  | `Array`, `Two Pointers`
