...
func TestLexicalDFS(t *testing.T) {
	test(t, lexicalOrderDFS)
}

func BenchmarkLexicalOrder(b *testing.B) {
	bench(b, lexicalOrder)
}

func BenchmarkLexicalOrderDFS(b *testing.B) {
	bench(b, lexicalOrderDFS)
}
